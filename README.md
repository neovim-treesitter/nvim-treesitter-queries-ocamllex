# nvim-treesitter-queries-ocamllex

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-ocamllex/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-ocamllex/actions/workflows/validate.yml)

Neovim tree-sitter queries for **ocamllex**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-ocamllex",
...
- [ ] Changes are scoped to `ocamllex` — do not include files for other languages
